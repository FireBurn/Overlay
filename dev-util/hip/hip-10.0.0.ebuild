...
src_configure() {
	...
	# CLR allocates some internal objects at the platform malloc alignment.
	# AVX-512 enabled by -march=native lets Clang emit 64-byte aligned stores
	# for them and crashes in hipMalloc on Zen 4 hosts.
