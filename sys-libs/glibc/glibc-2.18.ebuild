...
eblit-src_unpack-post() {
	...
	epatch "${FILESDIR}"/2.18/glibc-2.18-readdir_r-CVE-2013-4237.patch
	epatch "${FILESDIR}"/2.18/glibc-2.18-malloc-corrupt-CVE-2013-4332.patch
	epatch "${FILESDIR}"/2.18/glibc-2.18-strcoll-CVE-2012-4412+4424.patch
	epatch "${FILESDIR}"/2.18/glibc-2.18-getaddrinfo-CVE-2013-4458.patch
	epatch "${FILESDIR}"/2.18/glibc-2.18-getaddrinfo-assertion.patch
	epatch "${FILESDIR}"/2.18/glibc-2.18-scanf-parse-0e-0.patch
	epatch "${FILESDIR}"/2.18/glibc-2.18-strstr-proper.patch
